                            ...
                            <div>
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-8 col-md-12 col-sm-12">
                                        ...
                                        <input type="text" v-model="model.fieldOfStudy" class="form-control"
                                            id="fieldOfStudy" placeholder="Field of study">
                                        <div class="invalid-feedback">
                                            Field is required.
                                        </div>
                                    </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-8 col-md-12 col-sm-12">
                                        ...
                                        <textarea type="text" v-model="model.description" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                                        <div class="button-container">
                                            ...
                                            <router-link :to="{ name: 'educations-list' }"
