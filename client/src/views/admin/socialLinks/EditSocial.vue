                        ...
                        <div class="form-container">
                            ...
                            <div class="row g-3">
                                <div class="col-lg-8 col-md-12 col-sm-12">
                                    ...
                                    <input type="text" v-model="formData.url" class="form-control" id="url" placeholder="URL">
                                </div>
                            </div>
                                    ...
                                    <div class="edit-photo-wrapper">
                                        ...
                                        <div class="photo-buttons-wrapper">
                                            <div class="button-container">
                                                ...
                                                <div v-if="formData.icon !== null && formData.icon !== ''">
                                                    <button v-on:click.prevent="removeIcon()"
...
async function update() {
    ...
    try {
        await socialLinksService.update(id, formData.value)
            .then(response => {
