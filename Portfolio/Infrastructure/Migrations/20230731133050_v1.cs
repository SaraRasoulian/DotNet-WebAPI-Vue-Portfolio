    ...
    public partial class v1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("5a222dea-d789-4a99-858f-2895ae3722cf"), "In publishing and graphic design, Lorem ipsum is a placeholder text.", "Example@gmail.com", "Sara", "My name is Sara", "Rasoulian", null });

            migrationBuilder.InsertData(
                table: "SEOSettings",
                columns: new[] { "Id", "Favicon", "MetaAuthor", "MetaDescription", "MetaKeywords", "WebSiteTitle" },
                values: new object[] { new Guid("55a85ab5-c788-4ad2-b5e5-9a85f8d62484"), null, null, null, null, "Sara Rasoulian | Portfolio" });
        }
